...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Zamowienia.suma_netto_oferta'
        db.add_column('Zamowienia', 'suma_netto_oferta',
                      self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=7, decimal_places=2),
                      keep_default=False)

        # Adding field 'Zamowienia.suma_brutto_oferta'
        db.add_column('Zamowienia', 'suma_brutto_oferta',
                      self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=7, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Zamowienia.suma_netto_oferta'
        db.delete_column('Zamowienia', 'suma_netto_oferta')

        # Deleting field 'Zamowienia.suma_brutto_oferta'
        db.delete_column('Zamowienia', 'suma_brutto_oferta')
    ...
    models = {
        ...
        'konto.zamowienia': {
            ...
            'suma_brutto_oferta': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'max_digits': '7', 'decimal_places': '2'}),
            'suma_netto': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'max_digits': '7', 'decimal_places': '2'}),
            'suma_netto_oferta': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'max_digits': '7', 'decimal_places': '2'}),
